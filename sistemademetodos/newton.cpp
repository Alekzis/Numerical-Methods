...
double newton::funcion0(double c){
    return(exp(-c)-c); //original function

}
double newton::funciond1(double c)
{
    return(-exp(-c)-1);// first derivative

}
double newton::funciond2(double c)
{
    return(exp(-c));//second derivative

}
void newton::procesar(){
